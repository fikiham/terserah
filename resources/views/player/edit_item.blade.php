...
<div class="card mt-4">
    <div class="card-body">
        ...
        <form method="post" action="{{ route('player.update_item', $data->id_item) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="icon_source" name="icon_source" value="{{ $data->icon_source}}">
            </div>
            <div class="mb-3">
