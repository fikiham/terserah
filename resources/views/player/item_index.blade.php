...
<a href="{{ route('player.create_item') }}" type="button" class="btn btn-success rounded-3">Tambah Data</a>
...
<table class="table table-hover mt-2">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $data->icon_source }}</td>
            <td>{{ $data->id_benefit }}</td>
            <td>
                <a href="{{ route('player.edit_item',$data->id_item) }}" type="button" class="btn btn-warning rounded-3">
                    Ubah
                </a>

                <!-- TAMBAHKAN KODE DELETE DIBAWAH BARIS INI -->
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" 
                data-bs-target="#hapusModal{{ $data->id_item }}">
                    Hapus
                </button>
                <!-- Modal -->
                <div class="modal fade" id="hapusModal{{ $data->id_item }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('player.delete_item', $data->id_item) }}">
                                @csrf
                ...
                <div class="modal fade" id="hapusModal{{ $data->id_item }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('player.hdelete_item', $data->id_item) }}">
                                @csrf
